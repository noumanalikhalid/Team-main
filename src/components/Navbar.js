...
import { Bag, GeoAlt, Person } from 'react-bootstrap-icons'
    ...
    <>
     <MediaQuery minWidth={1216}>
      <div className={style.navbar} >
        <Link to={'/'}>
          <img src="https://cdn.ui.porsche.com/porsche-design-system/marque/porsche-marque-trademark.medium.min.fff6e9b91481cc5b1fc6c9b62987ccaf@2x.webp" className={style.logo} alt="Logo"/>
        </Link>
        ...
        <div className={style.modelImager} > 
          <div id="one" onMouseOverCapture={() => { mouseOver(); setNumber1() }} onMouseLeave={mouseLeave} className={style.model} >
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/718@2x.jpg" width="100px" alt="718"/>
            <p>718</p>
          </div>
          <div id="two" onMouseOverCapture={() => { mouseOver(); setNumber2() }} onMouseLeave={mouseLeave} className={style.model}>
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/911@2x.jpg" width="100px" alt="911"/>
            <p>911</p>
          </div>
          <div onMouseOver={() => { mouseOver(); setNumber3() }} onMouseLeave={mouseLeave} className={style.model}>
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/taycan@2x.jpg" width="100px" alt='Taycan'/>
            <p>Taycan</p>
          </div>
          <div onMouseOver={() => { mouseOver(); setNumber4() }} onMouseLeave={mouseLeave} className={style.model}>
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/panamera@2x.jpg" width="100px" alt='Panamera'/>
            <p>Panamera</p>
          </div>
          <div onMouseOver={() => { mouseOver(); setNumber5() }} onMouseLeave={mouseLeave} className={style.model}>
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/macan@2x.jpg" width="100px" alt="Macan"/>
            <p>Macan</p>
          </div>
          <div onMouseOver={() => { mouseOver(); setNumber6() }} onMouseLeave={mouseLeave} className={style.model}>
            <img src="https://nav.porsche.com/00BC524/series-assets/1024/cayenne@2x.jpg" width="100px" alt="Cayenne"/>
            <p>Cayenne</p>
          </div>
        </div>
        ...
        <div className={style.btnContain} onClick={showMenuFunc}>
          <img src="https://i.ibb.co/B6HwVZd/menu.png" className={style.menuBtn} alt="Menu" />
        </div>
      </div>
      </MediaQuery>
     ...
     <MediaQuery maxWidth={1215}>
      <div className={style.navbar2} style={{height: !showMenu ? "50px" : "120vh", position: showMenu ? "relative" : "static" }}>
        <Link to={'/'}>
          <img src="https://i.ibb.co/wBWTfPw/Porsche-logo.png" alt="Logo" className={style.logo} />
        </Link>
          ...
          <div className={style.modelImages} style={{ display: !showMenu ? "none" : "flex", flexDirection: "row" }}>
            <div id="one" onMouseOverCapture={() => { mouseOver(); setNumber1() }} onMouseLeave={mouseLeave} className={style.model} > 
              <img src="https://i.ibb.co/W2m2cpR/718.jpg" alt="718" />
              <p>718</p>
            </div>
            <div id="two" onMouseOverCapture={() => { mouseOver(); setNumber2() }} onMouseLeave={mouseLeave} className={style.model}>
              <img src="https://i.ibb.co/B4dyXG7/911.jpg" alt="911"/>
              <p>911</p>
            </div>
            <div onMouseOver={() => { mouseOver(); setNumber3() }} onMouseLeave={mouseLeave} className={style.model}>
              <img src="https://i.ibb.co/25FzmxQ/taycan.jpg" alt="Taycan"/>
              <p>Taycan</p>
            </div>
            <div onMouseOver={() => { mouseOver(); setNumber4() }} onMouseLeave={mouseLeave} className={style.model}>
              <img src="https://i.ibb.co/JrFNvpf/panamera.jpg" alt="Panamera"/>
              <p>Panamera</p>
            </div>
            <div onMouseOver={() => { mouseOver(); setNumber5() }} onMouseLeave={mouseLeave} className={style.model}>
              <img src="https://i.ibb.co/tqSVJCR/macan.jpg" alt="Macan"/>
              <p>Macan</p>
            </div>
            <div onMouseOver={() => { mouseOver(); setNumber6() }} onMouseLeave={mouseLeave} className={style.model}>
              <img src="https://i.ibb.co/6swS1s3/cayenne.jpg" alt="Cayenee"/>
              <p>Cayenne</p>
            </div>
          </div>
        ...
        <div className={style.links} >
          <ul>
            <li><img src="https://i.ibb.co/RvQCXbk/shopping-bag.png" width="20px" height="20px" alt="Shop" />Shop</li>
            <li><img src="https://i.ibb.co/cc8LV03/location.png" width="20px" height="20px" alt="Dealers"/>Dealers</li>
            <li><img src="https://i.ibb.co/K0vQd1G/person.png" width="20px" height="20px" alt="My Porsche"/>My Porsche</li>
            {/* <li><img src="https://i.ibb.co/mDYgtqb/dots.png" width="20px" height="20px" className={style.dots} /></li> */}
          </ul>
        </div>
        <div className={style.btnContain} onClick={showMenuFunc}>
          <img src="https://i.ibb.co/B6HwVZd/menu.png" alt="Menu" className={style.menuBtn} />
        </div>
      </div>
      </MediaQuery>
      {check()}
